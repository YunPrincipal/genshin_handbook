var char_info = [
    ...
    [5,"나히다","나히다","dendro","book","풀","분쟁을 멈추는 넝쿨","겁의 연꽃","포낭 결정 가루","창의","꼭두각시 줄"],
    [4,"노엘","노엘","stone","claymore","바위","현암의 탑","낙락베리","불길한 가면","투쟁","동풍의 발톱"],
    [5,"닐루","닐루","water","sword","물","영구동력 코어","파디사라","포낭 결정 가루","실천","액운을 쫓는 눈물"],
    [5,"다이루크","다이루크","fire","claymore","불","꺼지지 않는 불씨","등불꽃","위관의 휘장","투쟁","동풍의 깃털"],
    [5,"데히야","데히야","fire","claymore","불","빛 인도 사면체","모래 번데기","금자수 붉은 비단","실천","꼭두각시 줄"],
    [4,"도리","도리","elec","claymore","번개","번개를 품은 야생 열매","겁의 연꽃","금자수 붉은 비단","창의","혈옥의 가지"],
    ...
    [4,"레일라","레일라","ice","sword","얼음","영구동력 코어","달 연꽃","금주의 두루마리","창의","무념의 거울"],
    ...
    [4,"미카","미카","ice","polearm","얼음","푸른 꽃날개","고리고리 열매","위관의 휘장","시문","무념의 거울"],
    [4,"바바라","바바라","water","book","물","물처럼 맑은 마음","바람버섯","금주의 두루마리","자유","북풍의 고리"],
    [5,"방랑자","방랑자","wind","book","바람","영구동력 코어","룩카데바타 성체 버섯","명검 코등이","실천","공행의 방울"],
    [5,"백출","백출","dendro","book","풀","영원한 어둠의 고리","유리주머니","포낭 결정 가루","황금","천지에서 자란 고사리"],
    ...
    [5,"사이노","사이노","elec","polearm","번개","번개를 품은 야생 열매","황금 스카라브","금주의 두루마리","간언","흉장의 수안"],
    ...
    [5,"알하이탐","알하이탐","dendro","sword","풀","푸른 꽃날개","모래 번데기","금자수 붉은 비단","창의","무념의 거울"],
    ...
    [4,"요요","요요","dendro","polearm","풀","분쟁을 멈추는 넝쿨","절운고추","슬라임 원액","근면","공행의 방울"],
    ...
    [4,"카베","카베","dendro","claymore","풀","분쟁을 멈추는 넝쿨","애도의 꽃","포낭 결정 가루","창의","태초 오아시스의 첫 개화"],
    [5,"카즈하","카에데하라 카즈하","wind","sword","바람","꼭두각시 부품","바다 불로초","골드 까마귀 휘장","근면","순금의 비늘"],
    [5,"캔디스","캔디스","water","polearm","물","빛 인도 사면체","적념과","금자수 붉은 비단","간언","액운을 쫓는 눈물"],
    ...
    [4,"키라라","키라라","dendro","sword","풀","영원한 어둠의 고리","아마쿠모초 열매","떠도는 정령 코어","부세","고대 숲의 응고된 찰나"],
    ...
    [4,"파루잔","파루잔","wind","bow","바람","빛 인도 사면체","적념과","금자수 붉은 비단","간언","꼭두각시 줄"],

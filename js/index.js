var today = new Date();
var end_day = new Date ("2022-09-27 16:00:00");
var next_end_day = new Date("2022-10-14 19:00:00");
...
if (end_day >= today){
  ...
  wish_img1.src = "img/index/v3.01_char.jpg";
  wish_img2.src = "img/index/v3.01_weapon.jpg";
  ...
  wish_img1.src = "img/index/v3.10_char.jpg";
  wish_img2.src = "img/index/v3.10_weapon.jpg";

var today = new Date();
var end_day = new Date ("2023-04-11 16:00:00"); //현재 픽업 끝나는 시간
var next_end_day = new Date("2023-05-02 19:00:00"); //다음 픽업 끝나는 시간
...
if (end_day >= today){
  ...
  wish_img1.src = "img/index/v3.51_char.jpg"; //현재 픽업 배너
  wish_img2.src = "img/index/v3.51_weapon.jpg";
  ...
  wish_img1.src = "img/index/v3.60_char.jpg"; //다음 픽업 배너
  wish_img2.src = "img/index/v3.60_weapon.jpg";

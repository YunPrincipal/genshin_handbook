var today = new Date();
var end_day = new Date ("2022-11-02 12:00:00");
var next_end_day = new Date("2022-11-18 19:00:00");
...
if (end_day >= today){
  ...
  wish_img1.src = "img/index/v3.11_char.jpg";
  wish_img2.src = "img/index/v3.11_weapon.jpg";

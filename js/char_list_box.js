var char_info = [
    ...
    [24,"야에","야에 미코","elec","book","번개","용 자손의 가짜 지느러미","바다 불로초","명검 코등이","천광","만겁의 진의"],
    [25,"에일로이","에일로이","ice","bow","얼음","응결의 꽃","수정 골수","떠도는 정령 코어","자유","용해의 순간"],
    [26,"엠버","엠버","fire","bow","불","꺼지지 않는 불씨","등불꽃","역전의 화살촉","자유","동풍의 숨결"],
    [27,"연비","연비","fire","book","불","설익은 옥","야박석","골드 까마귀 휘장","황금","혈옥의 가지"],
    [28,"요이미야","요이미야","fire","bow","불","무형의 불 구슬","울림풀","금주의 두루마리","부세","용왕의 면류관"],
    [29,"운근","운근","stone","polearm","바위","수계 늑대왕의 그릇","유리백합","불길한 가면","근면","재가 된 심장"],
    [30,"유라","유라","ice","claymore","얼음","응결의 꽃","민들레 씨앗","불길한 가면","투쟁","용왕의 면류관"],
    [31,"응광","응광","stone","book","바위","현암의 탑","유리백합","위관의 휘장","번영","북풍의 영혼상자"],
    [32,"이토","아라타키 이토","stone","claymore","바위","수계 늑대왕의 그릇","귀신 풍뎅이","슬라임 원액","풍아","재가 된 심장"],
    [33,"종려","종려","stone","polearm","바위","현암의 탑","콜 라피스","슬라임 원액","황금","하늘을 삼킨 고래 뿔"],
    [34,"중운","중운","ice","claymore","얼음","서리의 핵","콜 라피스","불길한 가면","근면","동풍의 숨결"],
    [35,"진","진","wind","sword","바람","폭풍의 씨앗","민들레 씨앗","불길한 가면","투쟁","동풍의 깃털"],
    [36,"치치","치치","ice","sword","얼음","서리의 핵","유리주머니","금주의 두루마리","번영","북풍의 꼬리"],
    [37,"카즈하","카에데하라 카즈하","wind","sword","바람","꼭두각시 부품","바다 불로초","골드 까마귀 휘장","근면","순금의 비늘"],
    [38,"케이아","케이아","ice","sword","얼음","서리의 핵","통통 연꽃","골드 까마귀 휘장","시문","북풍의 영혼상자"],
    [39,"코코미","산고노미야 코코미","water","book","물","배척의 이슬","산호 진주","떠도는 정령 코어","부세","지옥불 나비"],
    [40,"클레","클레","fire","book","불","꺼지지 않는 불씨","바람버섯","금주의 두루마리","자유","북풍의 고리"],
    [41,"타르탈리야","타르탈리야","water","bow","물","물처럼 맑은 마음","별소라","위관의 휘장","자유","마왕의 칼날 조각"],
    [42,"토마","토마","fire","polearm","불","무형의 불 구슬","형광 버섯","골드 까마귀 휘장","부세","지옥불 나비"],
    [43,"피슬","피슬","elec","bow","번개","뇌광 프리즘","등불꽃","역전의 화살촉","시문","북풍의 영혼상자"],
    [44,"행추","행추","water","sword","물","물처럼 맑은 마음","예상꽃","불길한 가면","황금","북풍의 꼬리"],
    [45,"향릉","향릉","fire","polearm","불","꺼지지 않는 불씨","절운고추","슬라임 원액","근면","동풍의 발톱"],
    [46,"호두","호두","fire","polearm","불","설익은 옥","예상꽃","원소 꽃꿀","근면","마왕의 칼날 조각"]
    ];
